...
/**
 * Form bean for the userType search page.
 *
 * @author  DB team  Finalist IT Group
 * @version $Revision: 1.8 $, $Date: 2006/02/01 07:25:19 $
 * @struts.form name="userTypeSearchForm"
 */
public final class UserTypeSearchForm extends ServiceBaseForm {
   private String queryField;
   private String query;
   private Collection userTypeList;
    ...
    public Collection<LabeledIdentifier> getQueryFields() {
        ...
        list.add(bean);
        bean = new LabeledIdentifier();
        bean.setName("UserTypeName");
        bean.setId("userTypeName");
        list.add(bean);
        return list;
    }
   ...
   /**
    * Gets the list of userType beans, set in the {@link dbGarmentHibernate.actions.InitUserTypeSearchAction}.
    * @return Collection
    */
   public Collection getUserTypeList() {
      return userTypeList;
   }

   /**
    * Sets the list of userType beans.
    * @param userTypeList the list.
    */
   public void setUserTypeList(Collection userTypeList) {
