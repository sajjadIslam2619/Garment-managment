...
/**
 * The submit action for the userType search screen.
 *
 * @author  DB team  Finalist IT Group
 * @version $Revision: 1.3 $, $Date: 2006/01/20 13:10:17 $
 * @struts.action path="/UserTypeSearch"
 *                type="dbGarmentHibernate.actions.UserTypeSearchAction"
 *                name="userTypeSearchForm"
 *                scope="request"
 *                input="/usertypeList.jsp"
 * @struts.action-forward name="success" path="/initUserType.do"
 *
 */
public class UserTypeSearchAction extends ServiceAction {

   private static Logger log = LogService.getLogger(UserTypeSearchAction.class);
