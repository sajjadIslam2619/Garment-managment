...
/**
 * The submit action for the orderStatusType search screen.
 *
 * @author  DB team  Finalist IT Group
 * @version $Revision: 1.3 $, $Date: 2006/01/20 13:10:17 $
 * @struts.action path="/OrderStatusTypeSearch"
 *                type="dbGarmentHibernate.actions.OrderStatusTypeSearchAction"
 *                name="orderStatusTypeSearchForm"
 *                scope="request"
 *                input="/orderstatustypeList.jsp"
 * @struts.action-forward name="success" path="/initOrderStatusType.do"
 *
 */
public class OrderStatusTypeSearchAction extends ServiceAction {

   private static Logger log = LogService.getLogger(OrderStatusTypeSearchAction.class);
