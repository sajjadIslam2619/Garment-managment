...
/**
 * Form bean for the orderStatusType search page.
 *
 * @author  DB team  Finalist IT Group
 * @version $Revision: 1.8 $, $Date: 2006/02/01 07:25:19 $
 * @struts.form name="orderStatusTypeSearchForm"
 */
public final class OrderStatusTypeSearchForm extends ServiceBaseForm {
   private String queryField;
   private String query;
   private Collection orderStatusTypeList;
    ...
    public Collection<LabeledIdentifier> getQueryFields() {
        ...
        list.add(bean);
        bean = new LabeledIdentifier();
        bean.setName("OrderStatusName");
        bean.setId("orderStatusName");
        list.add(bean);
        return list;
    }
   ...
   /**
    * Gets the list of orderStatusType beans, set in the {@link dbGarmentHibernate.actions.InitOrderStatusTypeSearchAction}.
    * @return Collection
    */
   public Collection getOrderStatusTypeList() {
      return orderStatusTypeList;
   }

   /**
    * Sets the list of orderStatusType beans.
    * @param orderStatusTypeList the list.
    */
   public void setOrderStatusTypeList(Collection orderStatusTypeList) {
      this.orderStatusTypeList = orderStatusTypeList;
   }
