...
/**
 * Form bean for the userInfo search page.
 *
 * @author  DB team  Finalist IT Group
 * @version $Revision: 1.8 $, $Date: 2006/02/01 07:25:19 $
 * @struts.form name="userInfoSearchForm"
 */
public final class UserInfoSearchForm extends ServiceBaseForm {
   private String queryField;
   private String query;
   private Collection userInfoList;
    ...
    public Collection<LabeledIdentifier> getQueryFields() {
        ...
        list.add(bean);
        bean = new LabeledIdentifier();
        bean.setName("UserEmail");
        bean.setId("userEmail");
        list.add(bean);
        bean = new LabeledIdentifier();
        bean.setName("IdUserType");
        bean.setId("idUserType");
        list.add(bean);
        bean = new LabeledIdentifier();
   ...
   /**
    * Gets the list of userInfo beans, set in the {@link dbGarmentHibernate.actions.InitUserInfoSearchAction}.
    * @return Collection
    */
   public Collection getUserInfoList() {
      return userInfoList;
   }

   /**
    * Sets the list of userInfo beans.
    * @param userInfoList the list.
    */
   public void setUserInfoList(Collection userInfoList) {
