...
/**
 * Form bean for the orderType search page.
 *
 * @author  DB team  Finalist IT Group
 * @version $Revision: 1.8 $, $Date: 2006/02/01 07:25:19 $
 * @struts.form name="orderTypeSearchForm"
 */
public final class OrderTypeSearchForm extends ServiceBaseForm {
   private String queryField;
   private String query;
   private Collection orderTypeList;
    ...
    public Collection<LabeledIdentifier> getQueryFields() {
        ...
        list.add(bean);
        bean = new LabeledIdentifier();
        bean.setName("OrderName");
        bean.setId("orderName");
        list.add(bean);
        return list;
    }
   ...
   /**
    * Gets the list of orderType beans, set in the {@link dbGarmentHibernate.actions.InitOrderTypeSearchAction}.
    * @return Collection
    */
   public Collection getOrderTypeList() {
      return orderTypeList;
   }

   /**
    * Sets the list of orderType beans.
    * @param orderTypeList the list.
    */
   public void setOrderTypeList(Collection orderTypeList) {
