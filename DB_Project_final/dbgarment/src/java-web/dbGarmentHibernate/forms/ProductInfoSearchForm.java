...
/**
 * Form bean for the productInfo search page.
 *
 * @author  DB team  Finalist IT Group
 * @version $Revision: 1.8 $, $Date: 2006/02/01 07:25:19 $
 * @struts.form name="productInfoSearchForm"
 */
public final class ProductInfoSearchForm extends ServiceBaseForm {
   private String queryField;
   private String query;
   private Collection productInfoList;
    ...
    public Collection<LabeledIdentifier> getQueryFields() {
        ...
        bean.setId("productName");
        list.add(bean);
        bean = new LabeledIdentifier();
        bean.setName("IdProductType");
        bean.setId("idProductType");
        list.add(bean);
        bean = new LabeledIdentifier();
        bean.setName("ProductPrice");
        bean.setId("productPrice");
        list.add(bean);
        bean = new LabeledIdentifier();
        bean.setName("ProductImage");
        bean.setId("productImage");
        list.add(bean);
        return list;
    }
   ...
   /**
    * Gets the list of productInfo beans, set in the {@link dbGarmentHibernate.actions.InitProductInfoSearchAction}.
    * @return Collection
    */
   public Collection getProductInfoList() {
      return productInfoList;
   }

   /**
    * Sets the list of productInfo beans.
    * @param productInfoList the list.
    */
   public void setProductInfoList(Collection productInfoList) {
