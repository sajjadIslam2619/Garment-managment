...
/**
 * The submit action for the productInfo search screen.
 *
 * @author  DB team  Finalist IT Group
 * @version $Revision: 1.3 $, $Date: 2006/01/20 13:10:17 $
 * @struts.action path="/ProductInfoSearch"
 *                type="dbGarmentHibernate.actions.ProductInfoSearchAction"
 *                name="productInfoSearchForm"
 *                scope="request"
 *                input="/productinfoList.jsp"
 * @struts.action-forward name="success" path="/initProductInfo.do"
 *
 */
public class ProductInfoSearchAction extends ServiceAction {

   private static Logger log = LogService.getLogger(ProductInfoSearchAction.class);
