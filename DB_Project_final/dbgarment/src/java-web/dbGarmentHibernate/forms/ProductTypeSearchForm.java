...
/**
 * Form bean for the productType search page.
 *
 * @author  DB team  Finalist IT Group
 * @version $Revision: 1.8 $, $Date: 2006/02/01 07:25:19 $
 * @struts.form name="productTypeSearchForm"
 */
public final class ProductTypeSearchForm extends ServiceBaseForm {
   ...
   private Collection productTypeList;
    ...
    public Collection<LabeledIdentifier> getQueryFields() {
        ...
        list.add(bean);
        bean = new LabeledIdentifier();
        bean.setName("ProductTypeName");
        bean.setId("productTypeName");
        list.add(bean);
        return list;
    }
   ...
   /**
    * Gets the list of productType beans, set in the {@link dbGarmentHibernate.actions.InitProductTypeSearchAction}.
    * @return Collection
    */
   ...
   /**
    * Sets the list of productType beans.
    * @param productTypeList the list.
    */
