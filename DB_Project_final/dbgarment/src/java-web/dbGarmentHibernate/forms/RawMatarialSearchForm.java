...
/**
 * Form bean for the rawMatarial search page.
 *
 * @author  DB team  Finalist IT Group
 * @version $Revision: 1.8 $, $Date: 2006/02/01 07:25:19 $
 * @struts.form name="rawMatarialSearchForm"
 */
public final class RawMatarialSearchForm extends ServiceBaseForm {
   private String queryField;
   private String query;
   private Collection rawMatarialList;
    ...
    public Collection<LabeledIdentifier> getQueryFields() {
        ...
        bean.setName("IdRawMatarial");
        bean.setId("idRawMatarial");
        list.add(bean);
        bean = new LabeledIdentifier();
        ...
        list.add(bean);
        bean = new LabeledIdentifier();
        bean.setName("RawMaterialAmount");
        bean.setId("rawMaterialAmount");
        list.add(bean);
        bean = new LabeledIdentifier();
        bean.setName("PerUnitPrice");
        bean.setId("perUnitPrice");
        list.add(bean);
        return list;
    }
   ...
   /**
    * Gets the list of rawMatarial beans, set in the {@link dbGarmentHibernate.actions.InitRawMatarialSearchAction}.
    * @return Collection
    */
   public Collection getRawMatarialList() {
      return rawMatarialList;
   }

   /**
    * Sets the list of rawMatarial beans.
    * @param rawMatarialList the list.
    */
   public void setRawMatarialList(Collection rawMatarialList) {
      this.rawMatarialList = rawMatarialList;
   }
